package com.ahlanda.catatanharian;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Aplikasi Catatan Harianmu :D");
    ...
    void mengambilListFilePadaFolder() {
        String path = Environment.getExternalStorageDirectory().toString() + "/ahlanda.CatatanHarian";
